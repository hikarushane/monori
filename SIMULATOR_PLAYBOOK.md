...
|------|--------|--------|--------|-------|
| 2026-06-13 | B | R1 tap tab | PASS | `./scripts/ui-driver.sh describe` gives element frames; Library tab center (201, 832) reliable when the native tab bar is visible. The tab bar is covered by full-screen web views — tap Library immediately after relaunch, before Browse web content loads. |
