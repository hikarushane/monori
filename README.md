...
1. **瀏覽與登入**：Browse 分頁上方是來源選單，切換 Patreon、Google Docs、AO3、方格子、AsianFanfics。每個來源各自獨立的 WebView 與登入狀態，互不影響。在對應平台頁面用自己的帳號登入（Patreon 的 Google、Apple、Facebook 登入都在 app 內的彈出視窗完成）。
